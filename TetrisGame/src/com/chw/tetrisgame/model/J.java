...
public class J implements TetrisObject {

	//æ³¨æ„ï¼šCoordinate(åˆ?, è¡?)
	private final Coordinate[] stateOne = {new Coordinate(0, 0), new Coordinate(0, 1),
			new Coordinate(0, 2), new Coordinate(1, 0)};
	private final Coordinate[] stateTwo = {new Coordinate(0, 1), new Coordinate(0, 2), 
			new Coordinate(1, 2), new Coordinate(2, 2)};
	private final Coordinate[] stateThree = {new Coordinate(2, 0), new Coordinate(2, 1),
			new Coordinate(2, 2), new Coordinate(1, 2)};
	private final Coordinate[] stateFour = {new Coordinate(0, 0), new Coordinate(1, 0),
